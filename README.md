...
```
Para que no pierda su progreso en Yoshi, estos comandos realizarán un respaldo de su `database.json` y se agregará a la versión más reciente.
...
### `☄️ AGRADECIMIENTOS`
<a
href="https://github.com/elrebelde21"><img src="https://github.com/BrunoSobrino.png" width="100" height="100" alt="Diego"/></a>
